...
abstract public class EntityServiceTestBase {
  ...
  protected ChangeStreamProcessor _changeStreamProcessor;
  private final String entityName = "corpUser";
  ...
  public void testIngestSameAspect() throws Exception {
    ...
    assertFalse(
        DataTemplateUtil.areEqual(EntityUtils.parseSystemMetadata(readAspectV0.getSystemMetadata()), metadata2));
    assertFalse(
        DataTemplateUtil.areEqual(EntityUtils.parseSystemMetadata(readAspectV0.getSystemMetadata()), metadata1));
